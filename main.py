...
SHOP_ITEMS = {
    "hp_potion": {"name": "❤️ Зелье здоровья", "desc": "Восстанавливает 50 HP", "price": 30, "type": "consumable", "effect": {"hp": 50}},
    "big_hp_potion": {"name": "💖 Большое зелье здоровья", "desc": "Восстанавливает 150 HP", "price": 80, "type": "consumable", "effect": {"hp": 150}},
    "atk_scroll": {"name": "📜 Свиток силы", "desc": "+5 к атаке на 3 боя", "price": 100, "type": "buff", "effect": {"atk": 5, "duration": 3}},
    "def_scroll": {"name": "🛡️ Свиток защиты", "desc": "+5 к защите на 3 боя", "price": 100, "type": "buff", "effect": {"def": 5, "duration": 3}},
    "iron_sword": {"name": "🗡️ Железный меч", "desc": "+3 к атаке", "price": 200, "type": "equipment", "slot": "weapon", "effect": {"atk": 3}},
    "steel_sword": {"name": "⚔️ Стальной меч", "desc": "+7 к атаке", "price": 500, "type": "equipment", "slot": "weapon", "effect": {"atk": 7}},
    "iron_armor": {"name": "🥋 Железная броня", "desc": "+4 к защите", "price": 250, "type": "equipment", "slot": "armor", "effect": {"def": 4}},
    "steel_armor": {"name": "🛡️ Стальная броня", "desc": "+8 к защите", "price": 600, "type": "equipment", "slot": "armor", "effect": {"def": 8}},
    "lucky_ring": {"name": "💍 Кольцо удачи", "desc": "+10% крит", "price": 400, "type": "equipment", "slot": "accessory", "effect": {"crit": 10}},
    "revive_stone": {"name": "💎 Камень воскрешения", "desc": "Автовоскрешение при смерти", "price": 150, "type": "consumable", "effect": {"revive": 1}},
}
...
ACHIEVEMENTS = {
    "first_blood": {"name": "🩸 Первая кровь", "desc": "Убей первого монстра", "check": "dungeon_wins", "value": 1, "reward_gold": 20, "reward_gems": 1},
    "hunter_10": {"name": "🎯 Охотник", "desc": "Убей 10 монстров", "check": "dungeon_wins", "value": 10, "reward_gold": 50, "reward_gems": 2},
    "hunter_100": {"name": "💀 Истребитель", "desc": "Убей 100 монстров", "check": "dungeon_wins", "value": 100, "reward_gold": 200, "reward_gems": 10},
    "hunter_500": {"name": "☠️ Уничтожитель", "desc": "Убей 500 монстров", "check": "dungeon_wins", "value": 500, "reward_gold": 1000, "reward_gems": 30},
    "boss_1": {"name": "👑 Убийца боссов", "desc": "Убей первого босса", "check": "boss_kills", "value": 1, "reward_gold": 50, "reward_gems": 3},
    "boss_10": {"name": "🐲 Драконоборец", "desc": "Убей 10 боссов", "check": "boss_kills", "value": 10, "reward_gold": 200, "reward_gems": 8},
    "boss_50": {"name": "⚡ Повелитель боссов", "desc": "Убей 50 боссов", "check": "boss_kills", "value": 50, "reward_gold": 500, "reward_gems": 25},
    "pvp_1": {"name": "⚔️ Первый бой", "desc": "Выиграй PvP бой", "check": "wins", "value": 1, "reward_gold": 30, "reward_gems": 1},
    "pvp_10": {"name": "🏆 Гладиатор", "desc": "Выиграй 10 PvP боёв", "check": "wins", "value": 10, "reward_gold": 100, "reward_gems": 5},
    "pvp_50": {"name": "🏟️ Чемпион арены", "desc": "Выиграй 50 PvP боёв", "check": "wins", "value": 50, "reward_gold": 500, "reward_gems": 20},
    "lvl_5": {"name": "📊 Новичок+", "desc": "Достигни 5 уровня", "check": "level", "value": 5, "reward_gold": 30, "reward_gems": 2},
    "lvl_10": {"name": "📊 Опытный", "desc": "Достигни 10 уровня", "check": "level", "value": 10, "reward_gold": 100, "reward_gems": 5},
    "lvl_20": {"name": "📊 Ветеран", "desc": "Достигни 20 уровня", "check": "level", "value": 20, "reward_gold": 300, "reward_gems": 10},
    "lvl_30": {"name": "📊 Легенда", "desc": "Достигни 30 уровня", "check": "level", "value": 30, "reward_gold": 500, "reward_gems": 20},
    "gold_1000": {"name": "💰 Богач", "desc": "Заработай 1000 золота", "check": "total_gold_earned", "value": 1000, "reward_gold": 100, "reward_gems": 3},
    "gold_10000": {"name": "💰 Миллионер", "desc": "Заработай 10000 золота", "check": "total_gold_earned", "value": 10000, "reward_gold": 500, "reward_gems": 15},
    "streak_7": {"name": "🔥 Неделька", "desc": "7 дней подряд заходи в бот", "check": "streak", "value": 7, "reward_gold": 200, "reward_gems": 10},
    "streak_30": {"name": "🔥 Месяц!", "desc": "30 дней подряд!", "check": "streak", "value": 30, "reward_gold": 1000, "reward_gems": 50},
    "ref_5": {"name": "🔗 Рекрутер", "desc": "Пригласи 5 друзей", "check": "referral_count", "value": 5, "reward_gold": 200, "reward_gems": 10},
}

EXPEDITIONS = {
    "forest_patrol": {"name": "🌲 Патруль леса", "duration_min": 30, "gold": (20, 60), "xp": (10, 30), "gem_chance": 5},
    "mine_expedition": {"name": "⛏️ Разведка шахты", "duration_min": 60, "gold": (50, 150), "xp": (30, 80), "gem_chance": 10},
    "treasure_hunt": {"name": "🗺️ Охота за сокровищами", "duration_min": 120, "gold": (100, 400), "xp": (60, 200), "gem_chance": 20},
    "dragon_lair": {"name": "🐲 Логово дракона", "duration_min": 240, "gold": (300, 1000), "xp": (150, 500), "gem_chance": 35},
    "void_rift": {"name": "🌀 Разлом пустоты", "duration_min": 480, "gold": (500, 2000), "xp": (300, 1000), "gem_chance": 50, "min_lvl": 15},
}
...
async def cmd_start(message: Message):
    ...
    if user["class"]:
        ...
        for key, cls in CLASSES.items():
            text += f"{cls['name']} — {cls['desc']}\n  ❤️{cls['hp']} ⚔️{cls['atk']} 🛡️{cls['def']} 🎯{cls['crit']}%\n\n"
        kb = make_kb([
...
async def cb_daily(callback: CallbackQuery):
    ...
    if gems: text += f"💎 +{gems}\n"
    if energy_bonus: text += f"⚡ +{energy_bonus}\n"
    if wheel_spin: text += f"🎡 +{wheel_spin} вращение колеса!\n"
    text += "\n💡 Заходи каждый день!"
    ach_msg = await check_achievements(callback.from_user.id)
    if ach_msg: text += ach_msg
...
async def cb_enter_dungeon(callback: CallbackQuery):
    ...
    text = f"🏰 <b>{dungeon['name']}</b>\n⚡ {user['energy']} | ❤️ {user['hp']}/{user['max_hp']}\n\nМонстры:\n"
...
async def cb_fight_monster(callback: CallbackQuery):
    ...
    await update_user(callback.from_user.id, energy=user["energy"] - 1, last_energy=datetime.now().isoformat())
...
async def cb_fight_boss(callback: CallbackQuery):
    ...
    await update_user(callback.from_user.id, energy=user["energy"] - 2, last_energy=datetime.now().isoformat())
    ...
    if won:
        ...
        if random.randint(1, 100) <= 30:
            u = await get_user(callback.from_user.id)
            await update_user(callback.from_user.id, gems=u["gems"] + 2, total_gems_earned=u["total_gems_earned"] + 2)
            log += "\n💎 <b>+2 гема из босса!</b>"
    kb = make_kb([
...
async def cb_fight_elite(callback: CallbackQuery):
    ...
    await update_user(callback.from_user.id, energy=user["energy"] - 3, last_energy=datetime.now().isoformat())
...
async def cb_pvp_fight(callback: CallbackQuery):
    ...
    kb = make_kb([[("⚔️ Ещё!", "pvp_fight")], [("🔙 Арена", "pvp"), ("🏠 Меню", "main_menu")]])
    await callback.message.edit_text(log, reply_markup=kb)
    await callback.answer()
...
async def cb_game_dice(callback: CallbackQuery):
    ...
    kb = make_kb([
        ...
        [("7️⃣ Ровно 7 (x5)", "dice_seven")], [("🔙 Назад", "games")],
    ])
...
async def cb_dice_result(callback: CallbackQuery):
    ...
    total = d1 + d2
    won, mult = False, 0
    if bet == "high" and total > 7: won, mult = True, 2
    elif bet == "low" and total < 7: won, mult = True, 2
    elif bet == "seven" and total == 7: won, mult = True, 5
    ...
    text = (f"🎲 {d1} + {d2} = <b>{total}</b>\n\n"
            f"{'🏆 +' + str(winnings) + '💰' if won else '💀 -10💰'}\n💰 {new_gold}")
    kb = make_kb([[("🎲 Ещё", "game_dice")], [("🔙 Игры", "games"), ("🏠 Меню", "main_menu")]])
    await callback.message.edit_text(text, reply_markup=kb)
    await callback.answer()
...
async def cb_game_slots(callback: CallbackQuery):
    ...
    text = (f"🎰 <b>С Л О Т Ы</b>\n\n╔═══════════╗\n║  {s1}  {s2}  {s3}  ║\n╚═══════════╝\n\n"
            f"{'🏆 +' + str(winnings) + '💰' + jackpot if winnings else '💀 -20💰'}\n💰 {new_gold}")
    kb = make_kb([[("🎰 Ещё!", "game_slots")], [("🔙 Игры", "games"), ("🏠 Меню", "main_menu")]])
    await callback.message.edit_text(text, reply_markup=kb)
    await callback.answer()
...
async def cb_game_roulette(callback: CallbackQuery):
    kb = make_kb([
        ...
        [("🟢 Зеро (x10)", "roul_green")], [("🔙 Назад", "games")],
    ])
...
async def cb_roulette_result(callback: CallbackQuery):
    ...
    text = (f"🃏 Результат: <b>{names[result]}</b>\n\n"
            f"{'🏆 +' + str(winnings) + '💰' if won else '💀 -15💰'}\n💰 {new_gold}")
    kb = make_kb([[("🃏 Ещё", "game_roulette")], [("🔙 Игры", "games"), ("🏠 Меню", "main_menu")]])
    await callback.message.edit_text(text, reply_markup=kb)
    await callback.answer()
...
async def cb_open_chest(callback: CallbackQuery):
    ...
    if reward["type"] == "gold":
        ...
        await update_user(callback.from_user.id, gold=user["gold"] + amount, total_gold_earned=user["total_gold_earned"] + amount)
        ...
        amount = random.randint(reward["min"], reward["max"])
        await update_user(callback.from_user.id, gems=user["gems"] + amount, total_gems_earned=user["total_gems_earned"] + amount)
...
async def cb_craft(callback: CallbackQuery):
    ...
    for key, recipe in CRAFT_RECIPES.items():
        ...
        if recipe["cost_gold"]:
            ...
            if user["gold"] < recipe["cost_gold"]: can_craft = False
        if recipe["cost_gems"]:
            parts.append(f"{recipe['cost_gems']}💎")
            if user["gems"] < recipe["cost_gems"]: can_craft = False
        text += ", ".join(parts) + f" {'✅' if can_craft else '❌'}\n\n"
        if can_craft:
            buttons.append([(f"🔨 {recipe['name']}", f"docraft_{key}")])
    if not buttons: text += "❌ <i>Недостаточно материалов</i>\n"
    buttons.append([("🔙 Назад", "main_menu")])
    await callback.message.edit_text(text, reply_markup=make_kb(buttons))
    await callback.answer()
...
async def cb_docraft(callback: CallbackQuery):
    ...
    for ing_key, count in recipe["ingredients"].items():
        ...
        if ing_key in inventory:
            ...
            remaining -= take
            if inventory[ing_key] <= 0: del inventory[ing_key]
        if remaining > 0:
    ...
    upd = {"gold": user["gold"] - recipe["cost_gold"], "gems": user["gems"] - recipe["cost_gems"],
           "inventory": json.dumps(inventory), "crafts_done": user["crafts_done"] + 1}
    ...
    if user.get("expedition") and user.get("expedition_start"):
        ...
        if exp:
            ...
            if now >= end:
                ...
                kb = make_kb([[("🎁 Забрать награду!", "exp_collect")], [("🔙 Назад", "main_menu")]])
            else:
...
async def cb_exp_start(callback: CallbackQuery):
    ...
    await update_user(callback.from_user.id, expedition=key, expedition_start=datetime.now().isoformat())
...
async def cb_exp_collect(callback: CallbackQuery):
    ...
    upd = {"expedition": "", "expedition_start": "", "gold": user["gold"] + gold, "total_gold_earned": user["total_gold_earned"] + gold}
    if gems:
...
async def cb_wheel(callback: CallbackQuery):
    ...
    buttons = []
    if free_spin: buttons.append([("🎡 Бесплатное!", "spin_free")])
    if user["wheel_spins"] > 0: buttons.append([(f"🎡 Токен ({user['wheel_spins']})", "spin_token")])
...
async def do_spin(callback: CallbackQuery):
    ...
    if seg["type"] == "gold":
        await update_user(callback.from_user.id, gold=user["gold"] + seg["amount"], total_gold_earned=user["total_gold_earned"] + seg["amount"])
        text += f"💰 +{seg['amount']}!"
    elif seg["type"] == "gems":
        await update_user(callback.from_user.id, gems=user["gems"] + seg["amount"], total_gems_earned=user["total_gems_earned"] + seg["amount"])
        text += f"💎 +{seg['amount']}!"
    elif seg["type"] == "xp":
        ...
        max_e = user["max_energy"] + (VIP_BENEFITS["max_energy_bonus"] if is_vip(user) else 0)
        await update_user(callback.from_user.id, energy=min(user["energy"] + seg["amount"], max_e))
        text += f"⚡ +{seg['amount']}!"
    elif seg["type"] == "heal":
        ...
        await update_user(callback.from_user.id, gold=user["gold"] + bg, gems=user["gems"] + bge,
                          total_gold_earned=user["total_gold_earned"] + bg, total_gems_earned=user["total_gems_earned"] + bge)
...
async def cb_top(callback: CallbackQuery):
    ...
    order_map = {"level": ("level", "📊 По уровню"), "pvp": ("wins", "⚔️ PvP"),
                 "gold": ("gold", "💰 По золоту"), "bosses": ("boss_kills", "👑 Боссы"),
                 "gems": ("total_gems_earned", "💎 По гемам"), "elites": ("elite_kills", "🌟 Элиты")}
    ...
    if not players: text += "Пока никого нет.\n"
...
async def cb_check_payment(callback: CallbackQuery):
    ...
    if inv.get("status") == "paid":
        ...
        if item:
            user = await get_user(user_id)
            upd = {"gold": user["gold"] + item.get("gold", 0), "gems": user["gems"] + item.get("gems", 0),
                   "total_spent_usd": user["total_spent_usd"] + item["price_usd"]}
            if item.get("gems"): upd["total_gems_earned"] = user["total_gems_earned"] + item["gems"]
            ...
            if item.get("gold"): rewards.append(f"+{item['gold']}💰")
            if item.get("gems"): rewards.append(f"+{item['gems']}💎")
            if item.get("vip_days"): rewards.append(f"👑VIP {item['vip_days']}д")
...
async def cmd_promo(message: Message):
    ...
    r = []
    if promo["gold"]: r.append(f"+{promo['gold']}💰")
